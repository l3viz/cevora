...
To use these stylesheets, rename the files and myomega with the name of your theme.
...
myomega-alpha-default-narrow.css  
...
myomega-alpha-default-normal.css
...
myomega-alpha-default-wide.css
